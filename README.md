...
See Sections 5.1 and 5.2 of the [MUMPS User's Manual](http://mumps.enseeiht.fr/doc/userguide_5.0.2.pdf) for a description of the integer and real control arrays.
