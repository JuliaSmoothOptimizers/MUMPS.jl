...
mumps2 = quiet_mumps(ComplexF32; sym = mumps_unsymmetric)
...
mumps3 = quiet_mumps(ComplexF32; sym = mumps_unsymmetric)
...
mumps3_unsafe = quiet_mumps(ComplexF32; sym = mumps_unsymmetric)
A = sparse(random_matrix(ComplexF32, [1, 2, 3, 4], 4, 4))
